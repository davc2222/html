...
<nav class="mobile-bottom-nav <?= $isLoggedIn ? 'mobile-bottom-nav-logged' : 'mobile-bottom-nav-guest' ?>" aria-label="ניווט תחתון">
<?php if ($isLoggedIn): ?>
<a href="/?page=home"><span>🏠</span><small>בית</small></a>
<a href="/?page=search"><span>🔎</span><small>חיפוש</small></a>
<a href="/?page=advanced_search"><span>✨</span><small>התאמות</small></a>
<a href="/?page=messages"><span>💬</span><small>הודעות</small></a>
<a href="/?page=views"><span>👁️</span><small>צפיות</small></a>
<?php else: ?>
<a href="/?page=register"><span>📝</span><small>הרשמה</small></a>
<a href="/?page=login"><span>🔐</span><small>כניסה</small></a>
<a href="/?page=home"><span>🏠</span><small>בית</small></a>
<?php endif; ?>
</nav>
...
.mobile-bottom-nav{position:fixed;left:0;right:0;bottom:0;z-index:99990;height:58px;display:grid;background:#fff;border-top:1px solid #e5e7eb;box-shadow:0 -3px 12px rgba(15,23,42,.06);direction:rtl}
.mobile-bottom-nav-logged{grid-template-columns:repeat(5,1fr)}
.mobile-bottom-nav-guest{grid-template-columns:repeat(3,1fr)}
.mobile-bottom-nav a{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;color:#333;text-decoration:none;font-size:10px;font-weight:700}
