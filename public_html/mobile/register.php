    ...
    <div class="register-box">
        ...
        <?php if ($error !== ''): ?>
            <div class="message-box error">
                ...
                if ($error === 'doubleEmail') {
                    ...
                    echo 'שם המשתמש חייב להכיל רק אותיות באנגלית ומספרים, עד 15 תווים';
                } elseif ($error === 'email') {
                    echo 'כתובת האימייל אינה תקינה';
                } elseif ($error === 'pass') {
                    echo 'הסיסמה חייבת להכיל לפחות 4 תווים, אותיות באנגלית ומספרים';
                } elseif ($error === 'dob') {
                    echo 'יש להזין תאריך לידה תקין';
                } elseif ($error === 'invalidSelection') {
                    echo 'אחד מערכי הבחירה אינו תקין';
                } else {
        ...
        <form class="register-form" method="POST" action="/register_action.php">
            <div class="form-group">
                ...
                <input type="text" name="Name" id="Name" autocomplete="username" maxlength="15" required>
