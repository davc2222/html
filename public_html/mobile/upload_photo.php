...
function fail_upload(string $msg, int $userId = 0): void {
    ...
    if ($userId > 0) {
        echo '<p><a href="' . APP_URL . '/mobile/?page=profile&id=' . (int)$userId . '">חזרה לפרופיל</a></p>';
    } else {
        echo '<p><a href="' . APP_URL . '/mobile/">חזרה</a></p>';
    }
    echo '</body></html>';
    exit;
}
...
header('Location: ' . APP_URL . '/mobile/?page=profile&id=' . $userId . '&uploaded=1');
exit;
